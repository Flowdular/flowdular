...
/* The key prefixes are persisted in the workflows idempotency ledger, so they
   keep the name of the former integration module. */
...
/* The workflow capability is resolved per call: workflows.core may compose
   after automations.core, and a workspace may leave it uninstalled. */
export function registerWorkflowAutomationTarget(
