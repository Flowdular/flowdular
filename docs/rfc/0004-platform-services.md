...
- Status: accepted by the owner on 2026-09-12; the first wave (H14, H2, H1, H3, H4, H13, H5, H6, H7, H8 and the H12 documentation) delivered on 2026-09-12, see `docs/reviews/platform-services-rfc0004-2026-09-12.md`; H11 (SAML) waits for a buyer, H10 (PDF) waits for a business module naming the document, H9 (outbox) follows H2 when a second module needs decoupling, H12 (residency) is documentation; deferred items are tracked in `docs/deferred.md`
- Date: 2026-09-12
