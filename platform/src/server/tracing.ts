...
export interface PlatformObservabilityOptions {
	...
	/** The buffer the exporter drains. Defaults to the process tracer. */
	readonly tracer?: Tracer;
	/** The collector transport. Defaults to the global fetch. */
...
/**
 * Composes the two optional observability egresses for this generation.
 *
 ...
 * so this only validates it and drains it on retirement: a new generation must
 * not orphan the reports the previous one queued.
 */
